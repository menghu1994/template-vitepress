...
export default {
  ...
  themeConfig: {
    ...
    sidebar: generatorSides(flatNav(navConfig)),
    ...
    socialLinks: [
      {
        ...
        link: 'https://github.com/menghu1994'
      },
    ],
    outline: [2, 6],
    outlineTitle: '大纲目录',
    editLink: {
      pattern: 'https://github.com/menghu1994/template-vitepress/edit/main/docs/src/:path',
